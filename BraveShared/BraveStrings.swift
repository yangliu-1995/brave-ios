...
extension Strings {
    ...
    public static let restoreTabOnCrashAlertTitle = NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Well, this is embarrassing.",
    ...
    public static let restoreTabOnCrashAlertMessage = NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Looks like Brave crashed previously. Would you like to restore your tabs?",
...
extension Strings {
    public static let passcodeConfirmMisMatchErrorText = NSLocalizedString(
        "PasscodeConfirmMisMatchErrorText",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Passcodes didn’t match. Try again.",
        comment:
            "Error message displayed to user when their confirming passcode doesn't match the first code."
    )
    public static let passcodeMatchOldErrorText = NSLocalizedString(
        "PasscodeMatchOldErrorText",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "New passcode must be different than existing code.",
        comment:
...
extension Strings {
    ...
    public static let suppressAlertsActionMessage = NSLocalizedString(
        ...
        comment:
            "Message body of alert that seeks permission from user to suppress future JS alerts"
    )
}
...
extension Strings {
    ...
    public static let searchHistorySectionHeader = NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "History and bookmarks",
        comment: "Section header for history and bookmarks option"
    )
}

// MARK:-  TabPeekViewController.swift
extension Strings {
    public static let previewActionAddToBookmarksActionTitle = NSLocalizedString(
        "PreviewActionAddToBookmarksActionTitle",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Add to Bookmarks",
        comment: "Label for preview action on Tab Tray Tab to add current tab to Bookmarks"
    )
    public static let previewActionCopyURLActionTitle = NSLocalizedString(
        "PreviewActionCopyURLActionTitle",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Copy URL",
        comment:
    ...
    public static let previewActionCloseTabActionTitle = NSLocalizedString(
        "PreviewActionCloseTabActionTitle",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Close Tab",
        comment: "Label for preview action on Tab Tray Tab to close the current tab"
    )
    public static let previewFormatAccessibilityLabel = NSLocalizedString(
        "PreviewFormatAccessibilityLabel",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Preview of %@",
        comment:
...
extension Strings {
    ...
    public static let readerModeThemeButtonTitleLight = NSLocalizedString(
        "ReaderModeThemeButtonTitleLight",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Light",
        comment: "Light theme setting in Reading View settings"
    )
    public static let readerModeThemeButtonTitleDark = NSLocalizedString(
        "ReaderModeThemeButtonTitleDark",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Dark",
        comment: "Dark theme setting in Reading View settings"
    )
    public static let readerModeThemeButtonTitleSepia = NSLocalizedString(
        "ReaderModeThemeButtonTitleSepia",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Sepia",
...
extension Strings {
    public static let searchEnginePickerNavTitle = NSLocalizedString(
        "SearchEnginePickerNavTitle",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
...
extension Strings {
    ...
    public static let menuItemOpenAndFillTitle = NSLocalizedString(
        "MenuItemOpenAndFillTitle",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Open & Fill",
...
extension Strings {
    public static let authenticationPasscode = NSLocalizedString(
        "AuthenticationPasscode",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Passcode For Logins",
        comment: "Label for the Passcode item in Settings"
    )

    public static let authenticationTouchIDPasscodeSetting = NSLocalizedString(
        "AuthenticationTouchIDPasscodeSetting",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Touch ID & Passcode",
        comment: "Label for the Touch ID/Passcode item in Settings"
    )

    public static let authenticationFaceIDPasscodeSetting = NSLocalizedString(
        "AuthenticationFaceIDPasscodeSetting",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Face ID & Passcode",
        comment: "Label for the Face ID/Passcode item in Settings"
    )

    public static let authenticationRequirePasscode = NSLocalizedString(
        "AuthenticationRequirePasscode",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
    ...
    public static let authenticationEnterAPasscode = NSLocalizedString(
        "AuthenticationEnterAPasscode",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Enter a passcode",
        comment: "Text displayed above the input field when entering a new passcode"
    )

    public static let authenticationEnterPasscodeTitle = NSLocalizedString(
        "AuthenticationEnterPasscodeTitle",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
    ...
    public static let authenticationEnterPasscode = NSLocalizedString(
        "AuthenticationEnterPasscode",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Enter passcode",
    ...
    public static let authenticationReenterPasscode = NSLocalizedString(
        "AuthenticationReenterPasscode",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Re-enter passcode",
        comment: "Text displayed above the input field when confirming a passcode"
    )

    public static let authenticationSetPasscode = NSLocalizedString(
        "AuthenticationSetPasscode",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Set Passcode",
    ...
    public static let authenticationTurnOffPasscode = NSLocalizedString(
        "AuthenticationTurnOffPasscode",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Turn Passcode Off",
        comment: "Label used as a setting item to turn off passcode"
    )

    public static let authenticationTurnOnPasscode = NSLocalizedString(
        "AuthenticationTurnOnPasscode",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Turn Passcode On",
        comment: "Label used as a setting item to turn on passcode"
    )

    public static let authenticationChangePasscode = NSLocalizedString(
        "AuthenticationChangePasscode",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
    ...
    public static let authenticationEnterNewPasscode = NSLocalizedString(
        "AuthenticationEnterNewPasscode",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Enter a new passcode",
        comment: "Text displayed above the input field when changing the existing passcode"
    )

    public static let authenticationImmediately = NSLocalizedString(
        "AuthenticationImmediately",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Immediately",
        comment: "Immediately' interval item for selecting when to require passcode"
    )
    ...
    public static let authenticationLoginsTouchReason = NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Use your fingerprint to access Logins now.",
        comment: "Touch ID prompt subtitle when accessing logins"
    )

    public static let authenticationRequirePasscodeTouchReason = NSLocalizedString(
        "AuthenticationRequirePasscodeTouchReason",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
    ...
    public static let authenticationDisableTouchReason = NSLocalizedString(
        "AuthenticationDisableTouchReason",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
    ...
    public static let authenticationWrongPasscodeError = NSLocalizedString(
        "AuthenticationWrongPasscodeError",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
    ...
    public static let authenticationIncorrectAttemptsRemaining = NSLocalizedString(
        "AuthenticationIncorrectAttemptsRemaining",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Incorrect passcode. Try again (Attempts remaining: %d).",
        comment:
    ...
    public static let authenticationMaximumAttemptsReached = NSLocalizedString(
        "AuthenticationMaximumAttemptsReached",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
    ...
    public static let authenticationMaximumAttemptsReachedOneMinute = NSLocalizedString(
        "AuthenticationMaximumAttemptsReachedOneMinute",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
    ...
    public static let authenticationMaximumAttemptsReachedNoTime = NSLocalizedString(
        "AuthenticationMaximumAttemptsReachedNoTime",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Maximum attempts reached. Please try again later.",
        comment:
            "Error message displayed when user enters incorrect passcode and has reached the maximum number of attempts."
    )

    public static let authenticationTouchForKeyboard = NSLocalizedString(
        "AuthenticationTouchForKeyboard",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Tap to bring up the keyboard accessibility",
        comment:
            "When the user taps on the passcode pane, the touch gesture recognizer will bring up the keyboard back on the screen when hidden on iPad."
    )
}
...
extension Strings {
    ...
    public static let setDefaultBrowserCalloutTitle =
        NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "Brave can now be set as your default browser in iOS. Tap here to open settings.",
            comment: ""
        )
...
// MARK:- Error pages.
extension Strings {
    public static let errorPagesAdvancedButton = NSLocalizedString(
    ...
    public static let errorPagesAdvancedWarning1 = NSLocalizedString(
    ...
    public static let errorPagesAdvancedWarning2 = NSLocalizedString(
    ...
    public static let errorPagesCertWarningDescription = NSLocalizedString(
        "ErrorPagesCertWarningDescription",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value:
            "The owner of %@ has configured their website improperly. To protect your information from being stolen, Brave has not connected to this website.",
    ...
    public static let errorPagesGoBackButton = NSLocalizedString(
    ...
    public static let errorPagesVisitOnceButton = NSLocalizedString(
...
extension Strings {
    ...
    public static let syncUnableCreateGroup = NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Unable to create new sync group.",
...
extension Strings {
    ...
    public static let deleteBookmarksFolderAlertMessage = NSLocalizedString(
        ...
        bundle: Bundle.braveShared,
        value:
            "This will delete all folders and bookmarks inside. Are you sure you want to continue?",
...
extension Strings {
    ...
    public static let mediaAutoPlays = NSLocalizedString(
        "MediaAutoPlays",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Enable background video autoplay",
        comment: "Setting to allow media to play automatically"
    )
    ...
    public static let blockAdsAndTracking = NSLocalizedString(
        "BlockAdsAndTracking",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Block cross-site trackers",
        comment: ""
    )
    public static let blockAdsAndTrackingDescription = NSLocalizedString(
    ...
    public static let HTTPSEverywhereDescription = NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Opens some sites using a secure HTTPS connection instead of plain HTTP.",
        comment: ""
    )
    public static let blockPhishingAndMalware = NSLocalizedString(
        "BlockPhishingAndMalware",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Block Phishing and Malware",
        comment: ""
    )
    ...
    public static let googleSafeBrowsingUsingWebKitDescription = NSLocalizedString(
        ...
        bundle: Bundle.braveShared,
        value:
            "Sends obfuscated URLs of some pages you visit to the Google Safe Browsing service, when your security is at risk.",
        comment: ""
    )
    ...
    public static let blockPhishing = NSLocalizedString(
        "BlockPhishing",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Block Phishing",
        comment: "Brave panel individual toggle title"
    )
    ...
    public static let browserLockCalloutTitle = NSLocalizedString(
        "BrowserLockCalloutTitle",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Private means private.",
        comment: "Browser Lock feature callout title."
    )
    public static let browserLockCalloutMessage = NSLocalizedString(
        "BrowserLockCalloutMessage",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "With Browser Lock, you will need to enter a PIN in order to access Brave.",
        comment: "Browser Lock feature callout message."
    )
    public static let browserLockCalloutNotNow = NSLocalizedString(
        "BrowserLockCalloutNotNow",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Not Now",
        comment: "Browser Lock feature callout not now action."
    )
    public static let browserLockCalloutEnable = NSLocalizedString(
        "BrowserLockCalloutEnable",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Enable",
        comment: "Browser Lock feature callout enable action."
    )
    public static let DDGCalloutTitle = NSLocalizedString(
        "DDGCalloutTitle",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Private search with DuckDuckGo?",
        comment: "DuckDuckGo callout title."
    )
    public static let DDGCalloutMessage = NSLocalizedString(
        ...
        comment: "DuckDuckGo message."
    )
    public static let DDGCalloutNo = NSLocalizedString(
        "DDGCalloutNo",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "No",
        comment: "DuckDuckGo callout no action."
    )
    public static let DDGCalloutEnable = NSLocalizedString(
        "DDGCalloutEnable",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Yes",
        comment: "DuckDuckGo callout enable action."
    )
    public static let DDGPromotion = NSLocalizedString(
        "LearnAboutPrivateSearchrwithDuckDuckGo",
        tableName: "BraveShared",
        bundle: Bundle.braveShared,
        value: "Learn about private search \nwith DuckDuckGo",
        comment: "DuckDuckGo promotion label."
    )
...
extension Strings {
    ...
    public static let OBRewardsDetail = NSLocalizedString(
        "OBRewardsDetail",
        bundle: Bundle.braveShared,
        value: "Start supporting creators with private and anonymized ads while you browse",
        comment: "Detail text for rewards onboarding screen"
    )
    public static let OBRewardsAgreementTitle = NSLocalizedString(
        "OBRewardsAgreementTitle",
        bundle: Bundle.braveShared,
        value: "Brave Rewards supports creators",
    ...
    public static let OBRewardsAgreementDetail = NSLocalizedString(
        ...
        bundle: Bundle.braveShared,
        value: "By tapping Start, you agree to the",
...
// MARK: - User Wallet
extension Strings {
    public static let userWalletBATNotAllowedTitle = NSLocalizedString(
        "UserWalletDetailsDisconnectButtonTitle",
        bundle: Bundle.braveShared,
        value: "Region not supported",
        comment: ""
    )
    public static let userWalletBATNotAllowedMessage = NSLocalizedString(
        "UserWalletBATNotAllowedMessage",
        bundle: Bundle.braveShared,
        value:
    ...
    public static let userWalletBATNotAllowedLearnMore = NSLocalizedString(
        "UserWalletBATNotAllowedLearnMore",
        bundle: Bundle.braveShared,
        value: "Learn more",
        comment: ""
    )
    ...
    public struct NTP {
        ...
        public static let sponsoredImageDescription =
            NSLocalizedString(
                ...
                bundle: .braveShared,
                value:
                    "You’re supporting content creators and publishers by viewing this sponsored image.",
                comment: ""
            )
...
extension Strings {
    public struct Popover {
        public static let closeContextMenu = NSLocalizedString(
            "PopoverDefaultClose",
            bundle: Bundle.braveShared,
...
extension Strings {
    public struct Shields {
        ...
        public static let globalChangeButton = NSLocalizedString(
            ...
            bundle: Bundle.braveShared,
            value: "Change global Shields defaults",
            comment: ""
        )
...
extension Strings {
    public struct ShieldEducation {
        ...
        public static let trackerAdWarningTitle =
            NSLocalizedString(
                "shieldEducation.trackerAdWarningTitle",
                bundle: .braveShared,
        ...
        public static let trackerAdCountBlockTitle =
            NSLocalizedString(
                "shieldEducation.trackerAdCountBlockTitle",
                bundle: .braveShared,
                value: "%ld+ trackers & ads blocked on this page.",
                comment:
                    "Title for Shield Education Tracker Ad Count Block when block count raises over the defined limit. The parameter substituted for \"%ld\" is the limit of the trackers and ads blocked on the page when education pop over is presented. E.g.: 10+ trackers & ads blocked on the page"
            )

        public static let encryptedConnectionWarningTitle =
            NSLocalizedString(
                "shieldEducation.encryptedConnectionWarningTitle",
                bundle: .braveShared,
        ...
        public static let trackerAdCountBlockSubtitle =
            NSLocalizedString(
                "shieldEducation.trackerAdCountBlockSubtitle",
                bundle: .braveShared,
        ...
        public static let encryptedConnectionWarningSubtitle =
            NSLocalizedString(
                "shieldEducation.encryptedConnectionWarningSubtitle",
                bundle: .braveShared,
...
extension Strings {
    public struct VPN {
        ...
        public static let checkboxProtectConnections =
            NSLocalizedString(
                "vpn.checkboxProtectConnections",
                bundle: .braveShared,
    ...
    public struct Sync {
        public static let syncV1DeprecationText =
            NSLocalizedString(
                ...
                bundle: .braveShared,
                value:
                    "A new Brave Sync is coming and will affect your setup. Get ready for the upgrade.",
        ...
        public static let importFolderName = NSLocalizedString(
        ...
        public static let v2MigrationTitle =
            NSLocalizedString(
                "sync.v2MigrationTitle",
                tableName: "BraveShared",
                bundle: .braveShared,
                value: "Migration required",
                comment:
                    "Title for popup to inform the user that bookmarks migration is required for sync"
            )
        public static let v2MigrationMessage =
            NSLocalizedString(
                "sync.v2MigrationMessage",
                tableName: "BraveShared",
                bundle: .braveShared,
                value:
                    "In order to use Brave Sync your existing bookmarks must be migrated to use the new system. This operation will not delete your bookmarks.",
                comment:
                    "Message for popup to inform the user that bookmarks migration is required for sync"
            )
        public static let v2MigrationOKButton =
            NSLocalizedString(
                "sync.v2MigrationOKButton",
                tableName: "BraveShared",
                bundle: .braveShared,
                value: "Migrate",
...
extension Strings {
    public struct BraveToday {
        ...
        public static let introCardBody = NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "Brave Today is ad-supported with completely private and anonymized ads matched on your device.",
            comment: ""
        )
        public static let introCardNew = NSLocalizedString(
            ...
            value: "New",
            comment:
                "\"New\" as in a new feature being introduced, displayed above a body of text explaining said feature"
        )
        public static let introCardNewTextBody = NSLocalizedString(
            "today.introCardNewTextBody",
            bundle: .braveShared,
            value:
                "Customize Brave Today with up to 5 RSS feeds and get new content from your favorite publishers throughout the day.",
            comment: ""
        )
        ...
        public static let rssFeedLimitExceededAlertMessage = NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "The free ad-supported version of Brave Today includes 5 RSS feeds. You can customize your feed selections from the Sources list.",
            comment: ""
        )
        public static let rssFeedLimitRemainingFooter = NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "You currently have %d RSS feeds in your Sources list. The free ad-supported version of Brave Today includes 5 RSS feeds. Support for unlimited feeds and OPML import will be coming soon. You can customize your feed selections from the Sources list.",
        ...
        public static let searchTextFieldPlaceholder = NSLocalizedString(
            ...
            comment:
                "The placeholder displayed on the text field where a user is expected to type in a website URL"
        )
...
extension Strings {
    public struct RewardsInternals {
        ...
        public static let legacyWalletInfoHeader = NSLocalizedString(
            "RewardsInternalsLegacyWalletInfoHeader",
            bundle: Bundle.braveShared,
            value: "Legacy Wallet Info",
            comment: ""
        )
        public static let legacyWalletHasTransferrableBalance = NSLocalizedString(
            "RewardsInternalsLegacyWalletHasTransferrableBalance",
            bundle: Bundle.braveShared,
            value: "Has Transferrable Balance",
            comment: ""
        )
        ...
        public static let sharableBasicDescription = NSLocalizedString(
            ...
            bundle: Bundle.braveShared,
            value: "Wallet, device & balance info (always shared)",
            comment: ""
        )
        ...
        public static let sharingWarningMessage = NSLocalizedString(
            ...
            bundle: Bundle.braveShared,
            value:
                "Data on this page may be sensitive. Treat them as you would your wallet private keys. Be careful who you share them with.",
            comment: ""
        )
    }
}
...
extension Strings {
    public struct Rewards {
        ...
        public static let walletTransferStepsBody = NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "Your Brave Rewards token balance can be transfered to an existing Brave Rewards desktop wallet, one time.\n\n1. Open Brave Browser on your desktop\n2. Navigate to brave://rewards\n3. Click “QR Code”\n4. Scan QR Code with your device",
        ...
        public static let walletTransferCompleteBody = NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "Your transfer has initiated. Any existing BAT balance may take several minutes to appear in your desktop Brave Rewards wallet. Check your Rewards summary on Desktop for details when transfer has completed.\n\nYou may close this window and continue using Brave as your transfer is in progress.",
            comment:
        ...
        public static let transferNoLongerAvailableWarningMessage = NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "Please use the wallet transfer by March 13, 2021. Wallet transfer will no longer be available after March 13.",
            comment: ""
        )
        ...
        public static let legacyWalletTransferStatusPendingBody = NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "Your legacy wallet transfer status is pending and should begin processing shortly.",
            comment: ""
        )
        ...
        public static let legacyWalletTransferStatusInProgressBody = NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "Your legacy wallet transfer is in-progress and may take several minutes to complete.",
            comment: ""
        )
        ...
        public static let legacyWalletTransferStatusDelayedBody = NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "Your legacy wallet transfer has been delayed and may take several minutes to resume.",
            comment: ""
        )
        ...
        public static let legacyWalletTransferStatusCompletedBody = NSLocalizedString(
            ...
            bundle: .braveShared,
            value:
                "Your legacy wallet transfer is done! Your existing balance may still take several minutes to appear on your desktop Brave Rewards wallet.",
            comment: ""
        )
    }
}
