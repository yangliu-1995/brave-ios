...
public struct BraveUX {
    ...
    public static let braveVPNFaqURL = URL(
    ...
    public static let braveRewardsUnverifiedPublisherLearnMoreURL = URL(
    ...
    public static let tabsBarPlusButtonWidth =
        (UIDevice.current.userInterfaceIdiom == .pad) ? 40 : 0
    ...
    public static let locationBarBackgroundColor = #colorLiteral(
        red: 0.8431372549,
        green: 0.8431372549,
        blue: 0.8784313725,
        alpha: 1
    ...
    public static let locationContainerBackgroundColorPrivateMode =
        locationBarBackgroundColorPrivateMode
