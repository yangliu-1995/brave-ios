...
class UserReferralProgramTests: XCTestCase {
    ...
    func testSanitzerGoodInput() throws {
        let response = UserReferralProgram.sanitize(
            input: "\(UserReferralProgramTests.clipboardPrefix):ABC123"
        )
    ...
    func testSanitzerBadCode() throws {
        var response = UserReferralProgram.sanitize(
            input: "\(UserReferralProgramTests.clipboardPrefix):ABCA123"
        )
        XCTAssertNil(response)

        response = UserReferralProgram.sanitize(
            input: "\(UserReferralProgramTests.clipboardPrefix):ABc123"
        )
        XCTAssertNil(response)

        response = UserReferralProgram.sanitize(
            input: "\(UserReferralProgramTests.clipboardPrefix):ABC1234"
        )
        XCTAssertNil(response)

        response = UserReferralProgram.sanitize(
            input: "\(UserReferralProgramTests.clipboardPrefix):ABC12#"
        )
        XCTAssertNil(response)
        ...
        response = UserReferralProgram.sanitize(
            input: "\(UserReferralProgramTests.clipboardPrefix):AB123"
        )
        XCTAssertNil(response)

        response = UserReferralProgram.sanitize(
            input: "\(UserReferralProgramTests.clipboardPrefix):ÀBC123"
        )
        XCTAssertNil(response)
    ...
    func testSanitzerEmptyInput() throws {
        ...
        response = UserReferralProgram.sanitize(
            input: "\(UserReferralProgramTests.clipboardPrefix):"
        )
        XCTAssertNil(response)
