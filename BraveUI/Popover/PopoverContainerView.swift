    ...
    class ContainerView: UIView {
        ...
        override func layoutSubviews() {
            ...
            let clampedArrowXOrigin =
                min(
                    max(arrowOrigin.x, PopoverUX.cornerRadius + 1),
                    bounds.width - PopoverUX.cornerRadius - 1
                )
            ...
            popoverMaskView.triangleLayer.position = CGPoint(
                ...
                y: arrowDirection == .down
                    ? bounds.size.height - PopoverUX.arrowSize.height - 1.0 : 1.0
            )
