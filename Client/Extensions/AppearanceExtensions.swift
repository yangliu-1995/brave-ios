...
extension Theme {
    func applyAppearanceProperties() {
        ...
        UIView.appearance(whenContainedInInstancesOf: [BasePasscodeViewController.self])
            .appearanceBackgroundColor = colors.home
        ...
        UINavigationBar.appearance().largeTitleTextAttributes = [
            .foregroundColor: colors.tints.home
        ]
        ...
        UITableView.appearance().appearanceSeparatorColor = colors.border.withAlphaComponent(
            colors.transparencies.borderAlpha
        )
        ...
        UIImageView.appearance(whenContainedInInstancesOf: [SettingsViewController.self]).tintColor =
            colors.tints.home
        UIImageView.appearance(whenContainedInInstancesOf: [BraveRewardsSettingsViewController.self]
        )
        .tintColor = colors.tints.home

        UIView.appearance(whenContainedInInstancesOf: [UITableViewHeaderFooterView.self])
            .appearanceBackgroundColor = tablePrimaryColor

        UILabel.appearance(whenContainedInInstancesOf: [UITableView.self]).appearanceTextColor =
            colors.tints.home
        UILabel.appearance(whenContainedInInstancesOf: [UICollectionReusableView.self])
            .appearanceTextColor = colors.tints.home
        ...
        // Sync items
        SyncViewController.SyncView.appearance(whenContainedInInstancesOf: [
            UINavigationController.self
        ]
        ).appearanceBackgroundColor = colors.home
        SyncDeviceTypeButton.appearance().appearanceBackgroundColor = colors.header
        UIButton.appearance(
            whenContainedInInstancesOf: [SyncViewController.self]).appearanceTextColor =
            colors.tints.home
        ...
        InsetButton.appearance(whenContainedInInstancesOf: [SearchViewController.self])
            .appearanceBackgroundColor = .clear
