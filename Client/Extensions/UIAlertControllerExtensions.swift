...
extension UIAlertController {
    ...
    class func clearSyncedHistoryAlert(okayCallback: @escaping (UIAlertAction) -> Void)
        -> UIAlertController
    {
        let alert = UIAlertController(
            title: "",
...
class UserTextInputAlert {
    ...
    @objc private func textFieldChanged() {
        guard let textFields = alert.textFields, let firstText = textFields.first?.text else {
            return
        }
