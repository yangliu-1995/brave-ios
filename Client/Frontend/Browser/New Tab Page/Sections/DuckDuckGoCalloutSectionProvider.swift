...
class DuckDuckGoCalloutSectionProvider: NSObject, NTPObservableSectionProvider {
    ...
    private typealias DuckDuckGoCalloutCell = NewTabCenteredCollectionViewCell<
        DuckDuckGoCalloutButton
    >
    ...
    init(profile: Profile, action: @escaping () -> Void) {
        ...
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(privateModeChanged),
    ...
    private var isShowingCallout: Bool {
        let isSearchEngineSet =
            profile.searchEngines.defaultEngine(forType: .privateMode).shortName
    ...
    func collectionView(
        ...
        size.height =
            DuckDuckGoCalloutButton.UX.logoSize.height + DuckDuckGoCalloutButton.UX.padding.top
