...
class OnboardingWebViewController: UIViewController, WKNavigationDelegate {
    ...
    override func observeValue(
        ...
        guard let webView = object as? WKWebView, let kp = keyPath,
    ...
    private func updateBackForwardUI() {
        ...
        toolbar.backButton.tintColor =
            webView.canGoBack ? UX.buttonEnabledColor : UX.buttonDisabledColor

        toolbar.forwardButton.isEnabled = webView.canGoForward
        toolbar.forwardButton.tintColor =
            webView.canGoForward ? UX.buttonEnabledColor : UX.buttonDisabledColor
    }
