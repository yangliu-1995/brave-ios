...
class TabBarCell: UICollectionViewCell {
    ...
    private lazy var closeButton: UIButton = {
        ...
        button.tintColor =
            PrivateBrowsingManager.shared.isPrivateBrowsing ? UIColor.white : UIColor.black
    ...
    private lazy var separatorLine: UIView = {
        ...
        view.backgroundColor = theme.colors.border.withAlphaComponent(
    ...
    override init(frame: CGRect) {
        ...
        [closeButton, titleLabel, separatorLine, separatorLineRight].forEach {
