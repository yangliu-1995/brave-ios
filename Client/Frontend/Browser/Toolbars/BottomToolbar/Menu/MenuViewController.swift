...
class MenuViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.contentInset = UIEdgeInsets(
            top: UX.topBottomInset,
            left: 0,
            bottom: UX.topBottomInset,
            right: 0
        )
    ...
    private func openVPNAction(menuCell: MenuCell) {
        ...
        case .notPurchased, .purchased, .expired:
            ...
            open(
                vc,
                doneButton: DoneButton(style: .cancel, position: .left),
    ...
    private func openSettings() {
        let vc = SettingsViewController(
            ...
            rewards: bvc.rewards,
            legacyWallet: bvc.legacyWallet
        )
        vc.settingsDelegate = bvc
        open(
            vc,
            doneButton: DoneButton(style: .done, position: .right),
