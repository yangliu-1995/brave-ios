        ...
        dataSource.sections = contributions.map { cont in
            .init(
                ...
                rows: [
                    ...
                    Row(
                        text: Strings.RewardsInternals.retryCount,
                        detailText: "\(cont.retryCount)"
                    ),
                    Row(
                        text: Strings.RewardsInternals.processor,
                        detailText: cont.processor.displayText
                    ),
                    cont.publishers.count > 1
                        ? Row(
                            ...
                            selection: { [unowned self] in
                                let controller =
                                    RewardsInternalsContributionPublishersListController(
