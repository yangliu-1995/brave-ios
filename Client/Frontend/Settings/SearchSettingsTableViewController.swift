...
class SearchSettingsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.do {
            ...
            $0.register(
                UITableViewCell.self,
                forCellReuseIdentifier: Constants.searchEngineRowIdentifier
            )
            $0.register(
                UITableViewCell.self,
    ...
    private func configureSearchEnginePicker(_ type: DefaultEngineType) -> SearchEnginePicker {
        return SearchEnginePicker(type: type, showCancel: false).then {
            ...
            $0.engines =
                type == .privateMode
                ? searchPickerEngines.filter { !$0.isCustomEngine } : searchPickerEngines
            $0.delegate = self
            $0.selectedSearchEngineName = searchEngines.defaultEngine(forType: type).shortName
        }
    }

    private func configureSearchEngineCell(type: DefaultEngineType, engineName: String?)
        -> UITableViewCell
    {
        ...
        let cell = UITableViewCell(
            style: .value1,
            reuseIdentifier: Constants.searchEngineRowIdentifier
        )
        .then {
        ...
        -> UITableViewCell
    {
        ...
        if indexPath.section == Section.current.rawValue {
            ...
            case CurrentEngineType.private.rawValue:
                ...
                cell = configureSearchEngineCell(
                    type: .privateMode,
    ...
    {
        let headerView =
            tableView.dequeueReusableHeaderFooter() as SettingsTableSectionHeaderFooterView
        ...
        -> IndexPath?
    {
            ...
            && indexPath.item == CurrentEngineType.quick.rawValue
        {
            ...
            navigationController?.pushViewController(
                quickSearchEnginesViewController,
                animated: true
            )
