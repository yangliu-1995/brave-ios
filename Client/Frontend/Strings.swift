...
private func applicationBundle() -> Bundle {
    ...
    guard bundle.bundleURL.pathExtension == "appex",
        let applicationBundleURL = (bundle.bundleURL as NSURL).deletingLastPathComponent?
...
extension Strings {
    ...
    public static let settingsSearchEditButton = NSLocalizedString(
        "SettingsSearchEditButton",
        bundle: Bundle.shared,
        value: "Edit",
        comment: "Button displayed at the top of the search settings."
    )
    public static let useTouchID = NSLocalizedString(
        "UseTouchID",
        bundle: Bundle.shared,
        value: "Use Touch ID",
        comment: "List section title for when to use Touch ID"
    )
    public static let useFaceID = NSLocalizedString(
        "UseFaceID",
        bundle: Bundle.shared,
        value: "Use Face ID",
...
extension Strings {
    ...
    public static let findTitle = NSLocalizedString(
        "FindTitle",
        bundle: Bundle.shared,
        value: "Find",
        comment: "Label to display in the Discoverability overlay for keyboard shortcuts"
...
// Home page.
extension Strings {
    public static let setHomePageDialogTitle = NSLocalizedString(
        "SetHomePageDialogTitle",
        bundle: Bundle.shared,
        value: "Do you want to use this web page as your home page?",
        comment: "Alert dialog title when the user opens the home page for the first time."
    )
    public static let setHomePageDialogMessage = NSLocalizedString(
        "SetHomePageDialogMessage",
        bundle: Bundle.shared,
    ...
    public static let setHomePageDialogYes = NSLocalizedString(
        "SetHomePageDialogYes",
        bundle: Bundle.shared,
        value: "Set Homepage",
        comment: "Button accepting changes setting the home page for the first time."
    )
    public static let setHomePageDialogNo = NSLocalizedString(
        "SetHomePageDialogNo",
        bundle: Bundle.shared,
        value: "Cancel",
...
extension Strings {
    public static let settingsNewTabTopSites = NSLocalizedString(
        "SettingsNewTabTopSites",
        bundle: Bundle.shared,
        value: "Show your Top Sites",
        comment: "Option in settings to show top sites when you open a new tab"
    )
    public static let settingsNewTabBlankPage = NSLocalizedString(
        "SettingsNewTabBlankPage",
        bundle: Bundle.shared,
        value: "Show a Blank Page",
        comment: "Option in settings to show a blank page when you open a new tab"
    )
    public static let settingsNewTabHomePage = NSLocalizedString(
        "SettingsNewTabHomePage",
        bundle: Bundle.shared,
        value: "Show your Homepage",
...
extension Strings {
    ...
    public static let settingsAdvanceAccountSectionFooter =
        "To use a custom Brave Account and sync servers, specify the root Url of the Brave Account site. This will download the configuration and setup this device to use the new service. After the new service has been set, you will need to create a new Brave Account or login with an existing one."
    ...
    public static let settingsAdvanceAccountUrlUpdatedAlertMessage =
        "Brave account service updated. To begin using custom server, please log out and re-login."
    ...
    public static let settingsAdvanceAccountUrlErrorAlertMessage =
        "There was an error while attempting to parse the url. Please make sure that it is a valid Brave Account root url."
    ...
    public static let settingsAdvanceAccountUseCustomAccountsServiceTitle =
        "Use Custom Account Service"

    // Settings.AdvanceAccount.UrlEmptyErrorAlertMessage
    // No custom service set.
    public static let settingsAdvanceAccountEmptyUrlErrorAlertMessage =
        "Please enter a custom account url before enabling."
}
...
// Clipboard Toast
extension Strings {
    public static let goToCopiedLink = NSLocalizedString(
        "GoToCopiedLink",
        bundle: Bundle.shared,
...
extension Strings {
    ...
    public static let appMenuButtonAccessibilityLabel = NSLocalizedString(
        "AppMenuButtonAccessibilityLabel",
        bundle: Bundle.shared,
        value: "Menu",
...
extension Strings {
    public static let pasteAndGoTitle = NSLocalizedString(
        "PasteAndGoTitle",
        bundle: Bundle.shared,
        value: "Paste & Go",
        comment: "The title for the button that lets you paste and go to a URL"
    )
    public static let pasteTitle = NSLocalizedString(
        "PasteTitle",
        bundle: Bundle.shared,
        value: "Paste",
        comment: "The title for the button that lets you paste into the location bar"
    )
    public static let copyAddressTitle = NSLocalizedString(
        "CopyAddressTitle",
        bundle: Bundle.shared,
        value: "Copy Address",
