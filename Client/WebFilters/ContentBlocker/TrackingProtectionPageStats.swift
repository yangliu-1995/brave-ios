...
struct TPPageStats {
    ...
    func addingFingerprintingBlock() -> TPPageStats {
        return TPPageStats(
            ...
            fingerprintingCount: fingerprintingCount + 1,
    ...
    func addingScriptBlock() -> TPPageStats {
        return TPPageStats(
            ...
            fingerprintingCount: fingerprintingCount,
            httpsCount: httpsCount
        )
    }
...
class TPStatsBlocklistChecker {
    ...
    func isBlocked(request: URLRequest, domain: Domain, resourceType: TPStatsResourceType? = nil)
        -> Deferred<BlocklistName?>
    {
        ...
        adblockSerialQueue.async {
            ...
            let isAdOrTrackerListEnabled =
                enabledLists.contains(.ad) || enabledLists.contains(.tracker)
