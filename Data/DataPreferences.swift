    ...
    public final class Database {
        ...
        public final class DocumentToSupportDirectoryMigration {
            ...
            public static let completed = Option<Bool>(
                key: "database.document-to-support-directory-migration.completed",
                default: false
            )
            ...
            public static let previousAttemptedVersion = Option<String?>(
                key: "database.document-to-support-directory-migration.previous-attempted-version",
                default: nil
            )
        }

        public static let bookmark_v1_12_1RestorationCompleted = Option<Bool>(
            key: "database.1_12_1-bookmark-restoration-completed",
            default: false
        )
    }
}
