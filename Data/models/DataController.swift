...
public class DataController {
    ...
    private static let model: NSManagedObjectModel = {
        guard
            let modelURL = Bundle(for: DataController.self).url(
    ...
    public func migrateToNewPathIfNeeded() throws {
        ...
        do {
            ...
            throw MigrationError.MigrationFailed(
                "Document -> Support database migration failed: \(error)"
            )
        ...
        do {
            ...
            throw MigrationError.CleanupFailed(
                "Document -> Support database cleanup failed: \(error)"
            )
    ...
    static func perform(
        ...
        case .new(let inMemory):
            ...
            let queue =
                inMemory
                ? DataController.sharedInMemory.operationQueue
                : DataController.shared.operationQueue
    ...
    var storeURL: URL {
        let supportDirectory = Preferences.Database.DocumentToSupportDirectoryMigration.completed
            .value
