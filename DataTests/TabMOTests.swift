...
class TabMOTests: CoreDataTestCase {
    ...
    private func entity(for context: NSManagedObjectContext) -> NSEntityDescription {
        return NSEntityDescription.entity(
            forEntityName: String(describing: TabMO.self),
            in: context
        )!
    }
    ...
    func testUpdate() {
        ...
        let tabData = SavedTab(
            ...
            isSelected: true,
            order: 10,
            screenshot: UIImage.sampleImage(),
    ...
    func testImageUrl() {
        ...
        XCTAssertEqual(
            object.imageUrl,
            URL(string: "https://imagecache.mo/\(object.syncUUID!).png")
        )
    }
    ...
    func testGetAll() {
        ...
        let objectsSortedByOrder = try! DataController.viewContext.fetch(fetchRequest).sorted(by: {
            $0.order < $1.order
        })
